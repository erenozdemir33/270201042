...
if user_day > 31 or user_day == 0 : 
  print('Not exist')
elif (month_name == 'February' and user_day > 29) or (month_name == 'April' and user_day > 30) or (month_name == 'June' and user_day > 30) or (month_name == 'September' and user_day > 30) or (month_name == 'November' and user_day > 30) :
  print('Not exist')
